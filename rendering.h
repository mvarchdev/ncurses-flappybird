...
/// @brief For everything there will be used meters computation, for render it will be converted to characters - this constant defines how many characters equals one meter
...
int print_header_options(int option_items_n, int maxstrlen, char (*option_items)[*], int option_selected, int ypos);
